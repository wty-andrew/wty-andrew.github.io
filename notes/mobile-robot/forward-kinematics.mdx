...
---
import ICCAndRobot from '../../src/diagrams/icc-and-robot'
...
```cpp gazebo_ros_pkgs/gazebo_plugins/src/gazebo_ros_diff_drive.cpp mark=22,23
...
[1]: differential-drive-robot-model.mdx#unicycle-model
[2]: https://en.wikipedia.org/wiki/Euler_method
[3]: differential-drive-robot-model.mdx#differential-drive-model
